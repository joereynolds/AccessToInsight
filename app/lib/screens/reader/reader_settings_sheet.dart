          ...
          Row(
            children: [
              ...
              _buildThemeChoice(
                context,
                title: 'Ivory',
                style: AppThemeStyle.lightIvory,
                isSelected: settings.themeStyle == AppThemeStyle.lightIvory,
                color: AppColors.lightBg,
                textColor: AppColors.lightText,
                onTap: () => appState.updateThemeStyle(AppThemeStyle.lightIvory),
              ),
              const SizedBox(width: 10),
              _buildThemeChoice(
                context,
            ...
            children: [
              ...
              Expanded(
                child: Slider(
                  ...
                  max: 26.0,
                  divisions: 13,
                  activeColor: isDark ? AppColors.saffronMuted : AppColors.terracotta,
